...
const SideNav = (props: any) => {
  ...
  const [ProfileMenu, setProfileMenu] = createSignal<boolean>(false);

  createEffect(() => {
    window.addEventListener("click", (e) => {
      if (
        e.target !== document.getElementById("dropdown-user") &&
        e.target !== document.getElementById("dropdown-user-button") &&
        e.target !== document.getElementById("user-menu")
      ) {
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
              <div class="flex items-center ms-3">
                ...
                <div
                  class={`z-50 absolute my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 right-0 top-10
